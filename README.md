...
[![My Skills](https://skillicons.dev/icons?i=java,maven,react,js,html,css,sass,nextjs,redux,nodejs,materialui,jest,jenkins,jquery,figma,angular,aws,azure,bootstrap,docker,kubernetes,dynamodb,git,github,githubactions,grafana,mongodb,mysql,postgres,postman,spring,terraform,vue,webflow,webpack)](https://skillicons.dev)
